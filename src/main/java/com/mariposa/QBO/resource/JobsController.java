...
public class JobsController {
	...
	public String callJobsConcept(HttpSession session) {
		...
		try {
			...
			// get DataService
			DataService service = factory.getDataService(realmId, accessToken, MINOR_VERSION);
	 ...
	 * @throws FMSException
	 */
	private Estimate getEstimateWithMandatoryFields(Item item, Customer customer, DataService service)
			throws FMSException {
